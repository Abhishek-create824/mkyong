...
public class AppConfig {
	...
	private DriverManagerDataSource createDataSource() {
	    ...
	    driverManagerDataSource.setUrl("jdbc:hsqldb:file:~/desenv/github/mkyong/temp/h2/Spring-Security-Limit-Login-Attempts-Annotation-Example;sql.syntax_ora=true");
